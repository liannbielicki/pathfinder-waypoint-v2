...
Generated by `tests/test_load.py` on 2026-08-06T22:02:40.330535+00:00.
...
| Budget overshoot | none (reserved $140.0000 within run and day limits) |
| Pipeline elapsed | 1.39s |
| Handoff elapsed | 0.32s |
| Total elapsed | 1.71s (9 ms/Pro orchestration overhead) |
| Fake LLM calls | 1200 (6.0 per Pro) |
| Worker claims | 20 |
| Retries / 429s | 0 / 0 (fault injection covered in test_resume, test_queue, test_llm) |

## Reading

Orchestration overhead is ~9 ms/Pro. At ~7 model calls/Pro,
