...
import { getWorkbenchJob, startWorkbenchJob, WORKBENCH_ACTIVE_JOB_KEY, type WorkbenchTrace } from "@/lib/workbench";
...
type AuditItem = { key: string; observed_state?: string; observed_type?: string; source_query?: string };
  ...
  async function compile() {
    ...
    try {
      let job = await startWorkbenchJob({
        ...
        catalog_override: catalogEntries,
